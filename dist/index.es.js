...
function Drop({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Drop files or", " ", /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "upload_btn",
    onClick: () => imgInputRef.current.click()
  }, "Upload"))))), /*#__PURE__*/React.createElement("div", {
    className: "container"
  }, state.map((item, index) => /*#__PURE__*/React.createElement("div", {
    key: index
  }, type === "image" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("img", {
    src: item.url,
    alt: "dropimage",
    width: "80px",
    height: "50px",
  ...
  }), /*#__PURE__*/React.createElement("p", null, item?.name), /*#__PURE__*/React.createElement("button", {
    className: "delete_btn",
    onClick: () => handleRemove(item)
  }, "Delete")), type === "audio" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("audio", {
    controls: true
    ...
    className: "delete_btn",
    onClick: () => handleRemove(item)
  }, "Delete")), type === "video" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("video", {
    key: new Date().getMilliseconds(),
    style: {
      borderRadius: ".3rem",
      display: "flex",
